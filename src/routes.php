...
//Route::group(['middleware' => 'config'], function () {
    ...
    Route::get('add', [
        'as' => 'add',
        'uses' => 'Furqank786\Multitenancy\Controllers\SiteController@addsite',
    ]);
    // Route for add new site script to store in database.
    Route::post('add', [
        'as' => 'add',
        'uses' => 'Furqank786\Multitenancy\Controllers\SiteController@savesite',
    ]);

    // Route for get all the list.
//    Route::get('dashboard/list', [
//        'as' => 'list',
//        'uses' => 'Furqank786\Multitenancy\Controllers\SiteController@listsite',
//    ]);
    ...
    Route::get('dashboard/site/update/id/{id}/status/{status}', [
        'as' => 'update',
        'uses' => 'Furqank786\Multitenancy\Controllers\SiteController@updatesite',
    ]);
//});